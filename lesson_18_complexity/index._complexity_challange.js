...
console.log(loginUserOn("Harel_id_should_work", "harel_be_positive"))
console.log(loginUserOn("Harel_id_should_work", "harel_be_positive"))
console.log(loginUserOn("Harel_id_should_work", "harel_be_positive"))
console.log(loginUserOn("Harel_id_should_work", "harel_be_positive"))
const endDate = new Date().getTime()
console.log("End Time: O(n)", endDate - startdate)

const startdate1 = new Date().getTime()
console.log(loginUserO1("Harel_id_should_work", "harel_be_positive"))
console.log(loginUserO1("Harel_id_should_work", "harel_be_positive"))
console.log(loginUserO1("Harel_id_should_work", "harel_be_positive"))
console.log(loginUserO1("Harel_id_should_work", "harel_be_positive"))
const endDate1 = new Date().getTime()
console.log("End Time: O(1)", endDate1 - startdate1)
...
const cars = {
    "12432453": { color: "red", owner: "michalMiles" },
    "454535": { color: "pink", owner: "wili" },
    "8975555": { color: "green", owner: "adi" },
}

// for (let index = 0; index < 99999; index++) {
//     console.log("Adi is measuring preformance")
