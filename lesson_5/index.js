var car = "Skoda Kodiak 2020 white price:" + 100000;
var cars = [car, car, car] //500 

// JSON 
// Javascript object notation 
var carObj = { model: "Skoda", year: 2022 }
var carsArr = [
    {
...
var carsWithLP = carsArr.map((currentCar) => {
    ...
    allCarsInObject[id] = currentCar
    return { ...currentCar, lp: id }
})
var carsWIth4Cylinders = []
for (let index = 0; index < carsArr.length; index++) {
    var currentCar = carsArr[index]
    if (currentCar.Cylinders === 4) {
